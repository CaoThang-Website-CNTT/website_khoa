document.addEventListener("DOMContentLoaded", () => {
  ...
  function selectTarget(item) {
    ...
    // techdebt: API search-merge có thể thiếu email, sđt. Do chưa có API lấy chi tiết công ty (GET /companies/{id}),
    // nên tạm thời dùng luôn dữ liệu từ object kết quả search để hiển thị. Cần đảm bảo API search trả về đủ data.
  ...
  function populateTargetFields(item) {
    document.querySelectorAll(".field-row").forEach((row) => {
      ...
      // Auto select target if target has value and source is empty
  ...
  // Prefill if query is provided in query params
