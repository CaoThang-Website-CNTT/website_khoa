 ...
 *
 * Triết lý: renderer không bao giờ nhận raw input chưa qua validate.
 * Validator trả về normalized data hoặc ném BlockValidationException.
 *
    ...
    public static function validatePayload(mixed $payload): array
    {
        ...
        foreach ($blocks as $index => $block) {
            try {
                ...
                // Re-throw với context để dễ debug
