<section class="about__breadcrumb container">
  <div class="container-wrapper py-4 flex items-center gap-2">
    ...
    <div class="about__breadcrumb-link about__breadcrumb-link--active flex items-center font-medium">
      <span class="about__breadcrumb-text text-sm">Giới Thiệu</span>
    </div>
  </div>
</section>

<section class="about__hero relative flex flex-col justify-start items-center overflow-hidden w-full">
...
<section class="about__history container my-16">
  <div class="about__history-container container-wrapper flex items-center justify-center gap-12">
    <div class="about__history-image-container relative overflow-hidden rounded-3xl flex-1">
      <img class="about__history-image object-cover image" src="./public/img/about.jpg" alt="Năm 2003">
      <div class="about__history-image-caption absolute inset-0 z-10 flex flex-col justify-end gap-2 p-8">
        <h2 class="about__history-image-year text-6xl">2003</h2>
        <h3 class="about__history-image-title text-2xl">Khoa CNTT được thành lập</h3>
      </div>
    </div>
    ...
    <div class="about__history-content w-full flex-1">
      ...
      <div class="about__history-timeline-wrapper flex flex-col gap-4 text-md mb-8">
        <div class="about__history-timeline flex flex-col gap-4">
          <div class="about__history-timeline-item flex gap-4">
            <span class="about__history-timeline-year font-bold">1998:</span>
          ...
          <div class="about__history-timeline-item flex gap-4">
            <span class="about__history-timeline-year font-bold">2020:</span>
            <span class="about__history-timeline-desc">Đổi tên Khoa Điện tử - Tin học thành Khoa Công nghệ
              thông tin.</span>
          </div>
          <div class="about__history-timeline-item flex gap-4">
            <span class="about__history-timeline-year font-bold">2017:</span>
            <span class="about__history-timeline-desc">Đổi tên Khoa Điện tử - Tin học thành Khoa Công nghệ
              thông tin.</span>
          </div>
          <div class="about__history-timeline-item flex gap-4">
            <b class="about__history-timeline-year font-bold">2025:</b>
            <span class="about__history-timeline-desc">Đổi tên Khoa Điện tử - Tin học thành Khoa Công nghệ
              thông tin.</span>
          </div>
        </div>
      ...
      <div class="about__history-stats flex flex-row lg:flex-col gap-4 w-full lg:w-auto">
        <div class="about__history-stat-card rounded-3xl p-4 flex flex-col flex-1">
          <h2 class="about__history-stat-number text-3xl">5,247</h2>
          <div class="about__history-stat-label text-sm">Sinh viên tốt nghiệp</div>
        </div>
        <div class="about__history-stat-card rounded-3xl p-4 flex flex-col flex-1">
          <div class="about__history-stat-number text-3xl">65</div>
          <div class="about__history-stat-label text-sm">Giảng viên</div>
        </div>
        <div class="about__history-stat-card rounded-3xl p-4 flex flex-col flex-1">
          <div class="about__history-stat-number text-3xl">28</div>
          <div class="about__history-stat-label text-sm">Đối tác quốc tế</div>
        </div>
      </div>
    </div>
  </div>
...
<section class="about__tradition container flex items-start my-16">
  <div class="about__tradition-container container-wrapper flex items-start justify-center gap-12 ">
    <div class="about__tradition-content flex-1">
      ...
      <div class="about__tradition-header">
        <h2 class="about__tradition-title text-5xl mb-6">100+ năm truyền thống</h2>
      </div>

      <div class="about__tradition-timeline flex flex-col gap-4">
        <div class="about__tradition-timeline-item flex gap-4">
          <span class="about__tradition-timeline-year font-bold">1906:</span>
        ...
        <div class="about__tradition-timeline-item flex gap-4">
          <span class="about__tradition-timeline-year font-bold">1915:</span>
          <span class="about__tradition-timeline-desc">Chủ tịch Tôn Đức Thắng nhập học.</span>
        </div>
        <div class="about__tradition-timeline-item flex gap-4">
          <span class="about__tradition-timeline-year font-bold">2004:</span>
          <span class="about__tradition-timeline-desc">Chính thức đổi tên thành Trường Cao đẳng Kỹ thuật Cao
            Thắng.</span>
        </div>
        <div class="about__tradition-timeline-item flex gap-4">
          <span class="about__tradition-timeline-year font-bold">2016:</span>
          <span class="about__tradition-timeline-desc">Đạt chuẩn kiểm định quốc tế ABET.</span>
        </div>
      </div>
    </div>

    <div class="about__tradition-image-container relative overflow-hidden rounded-3xl flex-1 my-5">
      <img class="about__tradition-image object-cover image" src="./public/img/about.jpg" alt="Năm 1906">
      <div class="about__tradition-image-caption absolute inset-0 z-10 flex flex-col justify-end gap-2 p-8">
        <h2 class="about__tradition-image-year text-6xl">1906</h2>
...
<section class="about__features container my-16">
  <div class="about__features-container container-wrapper">
    <div class="about__features-grid">
      <!-- Card 1: Primary Achievement (Blue - Large) -->
      <div class="about__feature-card about__feature-card--primary">
        <img class="about__feature-card__bg image" src="./public/img/about02.png" alt="Chứng nhận Quốc tế">
        <div class="about__feature-card__content">
          <div class="about__feature-card__header">
            <div class="about__feature-card__badge">
          ...
          <div class="about__feature-card__stats">
            <div class="about__feature-card__stat px-6 py-4">
              <h3 class="about__feature-card__stat-num text-3xl">30+</h3>
              <span class="about__feature-card__stat-label text-sm">Quốc gia công nhận</span>
            </div>
            <div class="about__feature-card__stat px-6 py-4">
              <h3 class="about__feature-card__stat-num text-3xl">Top 5</h3>
              <span class="about__feature-card__stat-label text-sm">Khoa CNTT VN</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="about__feature-card about__feature-card--green">
        <div class="about__feature-card__icon">
      ...
      <div class="about__feature-card about__feature-card--purple-pink">
        <div class="about__feature-card__icon">
      ...
      <div class="about__feature-card about__feature-card--image">
        <img class="about__feature-card__bg image" src="./public/img/about03.png" alt="Cộng đồng học tập">
        <div class="about__feature-card__overlay"></div>
        <div class="about__feature-card__content about__feature-card__content--bottom">
          <div class="about__feature-card__title about__feature-card__title--large">
      ...
      <div class="about__feature-card about__feature-card--orange">
        <div class="about__feature-card__icon">
      ...
      <div class="about__feature-card about__feature-card--white">
        <div class="about__feature-card__icon about__feature-card__icon--blue">
      ...
      <div class="about__feature-card about__feature-card--dark">
        <div class="about__feature-card__icon">
      ...
      <div class="about__feature-card about__feature-card--cyan">
        <div class="about__feature-card__icon">
