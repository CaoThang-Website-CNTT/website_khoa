...
<h2 class="title-wrapper__title">Thêm đợt thực tập mới</h2>
            ...
            <div class="card__content">
              ...
              <div class="field">
                ...
                <div class="flex gap-4 items-center">
                  ...
                  <span class="text-sm" id="upload-status-text"></span>
                </div>
                <p class="field__description">
                  Lưu ý: Mẫu file yêu cầu cột theo thứ tự (A: STT, B: MSSV, C: Họ đệm, D: Tên, E: Ngày sinh, F: Lớp).
              ...
              <div id="wrapper-table-students-import" class="mt-6" data-state="closed">
                ...
                <div class="tm-container" data-tm="table-students-import" data-tm-mode="client"
                  data-tm-selectable="true" data-tm-searchable="true" data-tm-filterable="false" data-tm-limit="20"
                  data-tm-strategy="ajax" data-tm-id-key="_id">
  ...
  <div class="modal" id="skip-step3-confirm-modal" tabindex="-1" data-state="closed">
    <div class="modal__header">
      ...
      <p class="modal__description" id="skip-step3-confirm-msg">Bạn chưa hoàn tất chỉ định giảng viên hướng dẫn trong
        đợt thực tập. Bạn có chắc muốn tiếp tục tạo đợt thực tập này không?</p>
    </div>
    <div class="modal__footer">
      <button data-modal-close data-variant="outline" class="btn" data-size="lg" type="button">Hủy</button>
      <button id="skip-step3-confirm-btn" data-variant="primary" class="btn" data-size="lg" type="button">Đồng
        ý</button>
    </div>
