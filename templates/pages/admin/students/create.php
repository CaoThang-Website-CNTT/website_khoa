...
<p class="title-wrapper__description">Điền thông tin sinh viên mới vào các trường dưới đây</p>
<?php $layout->end() ?>
...
<script src="<?= url('public/js/pages/admin/students/create.js') ?>" type="module"></script>
<?php $layout->end() ?>
