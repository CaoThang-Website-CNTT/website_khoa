                        ...
                        <?php if (!empty($week['report']['images'])): ?>
                          <div class="weekly-attachments">
                            <?php foreach ($week['report']['images'] as $image): ?>
                              <a href="<?= url('public/storage/' . ltrim($image['file_path'], '/')) ?>" target="_blank" rel="noopener">
                                <img src="<?= url('public/storage/' . ltrim($image['file_path'], '/')) ?>" alt="<?= htmlspecialchars($image['original_file_name']) ?>">
                              </a>
                            <?php endforeach; ?>
                          </div>
                        <?php endif; ?>
