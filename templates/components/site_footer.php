    ...
    <div class="footer__info">
      <div class="footer__brand-group flex gap-3 mb-4 items-center">
        <div class="footer__logo overflow-hidden rounded-full">
          <img class="footer__logo-image w-full h-full object-fit" src="./public/img/faculty_logo.jpg"
      ...
      <ul class="footer__social-list flex gap-2 items-center">
        <li class="footer__social-item">
          <a href="#" class="footer__social-link p-3 link-hover--standout">
            <svg aria-label="Facebook Link" width="16" height="16" viewBox="0 0 16 16" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <li class="footer__social-item">
          <a href="#" class="footer__social-link p-3 link-hover--standout">
            <svg aria-label="Youtube Link" width="16" height="16" viewBox="0 0 16 16" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <li class="footer__social-item">
          <a href="#" class="footer__social-link p-3 link-hover--standout">
            <svg aria-label="Instagram Link" width="16" height="16" viewBox="0 0 16 16" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
