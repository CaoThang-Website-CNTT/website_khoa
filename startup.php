...
require_once BASE_PATH . '/includes/cms/cms_page_state.php';
require_once BASE_PATH . '/includes/cms/landing_page_defaults.php';
require_once BASE_PATH . '/includes/cms/about_page_defaults.php';
...
require_once BASE_PATH . '/controllers/web/teacher_project_dashboard_controller.php';
