...
{
  private string $title = "Trải nghiệm Khoa CNTT Cao Thắng";
  private string $sub_title = "Nơi ươm mầm tài năng công nghệ thông tin, kết nối tri thức với thực tiễn";
  ...
  private array $outstanding_info = [
    ...
    ['icon' => ['file_name' => 'roket_icon', 'alt' => 'Roket Icon'], 'title' => 'Khởi nghiệp', 'short' => 'Hỗ trợ ý tưởng startup và kết nối nhà đầu tư']
  ];
