...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="/website_khoacntt_caothang/public/favicon-32x32.png" />
  <link rel="preload" as="style" href="/website_khoacntt_caothang/public/css/fonts.css" />
  <link rel="stylesheet" href="/website_khoacntt_caothang/public/css/fonts.css" />
  <link rel="preload" as="style" href="/website_khoacntt_caothang/public/css/base.css" />
  <link rel="stylesheet" href="/website_khoacntt_caothang/public/css/base.css" />
  <link rel="preload" as="style" href="/website_khoacntt_caothang/public/css/main.css" />
  <link rel="stylesheet" href="/website_khoacntt_caothang/public/css/main.css" />
  <link rel="stylesheet" href="/website_khoacntt_caothang/public/css/carousel.css" />
  <title>Khoa Công nghệ Thông tin - Trường CĐKT Cao Thắng</title>
  <script src="/website_khoacntt_caothang/public/js/utils.js"></script>
</head>
    ...
    <div class="banner py-2">
      <div class="container flex gap-4 px-4 font-light">
        <div class="flex items-center gap-1">
          <svg class="banner__icon" alt="Email Icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex items-center gap-1">
          <svg class="banner__icon" alt="Phone Icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex justify-between items-center p-4">
          <div class="flex gap-4">
            <div class="web-logo object-contain">
              <img src="/website_khoacntt_caothang/public/img/faculty_logo.jpg"
          ...
          <div class="search-bar flex items-center px-4 gap-2 rounded-2xl text-sm">
            <svg alt="Search Icon" width="16" height="16" viewBox="0 0 16 16" fill="none"
      ...
      <nav class="navbar">
        <div class="container flex py-2 px-4 gap-4">
          ...
          <div class="navbar__item flex items-center py-2 gap-2 z-50 relative">
            ...
            <svg class="dropdown-icon" alt="Dropdown Icon" width="16" height="16" viewBox="0 0 16 16" fill="none"
              xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="dropdown-menu absolute rounded-md">
              <a class="dropdown-menu__item flex justify-between items-center px-4 py-2" href="/gioi-thieu/chung">
                ...
                <div>
                  <svg alt="Dropdown Item Go-to Icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
  ...
  <section class="relative" id="hero-section">
    <div class="container">
      <div class="carousel py-8 relative" id="learningCarousel">
        ...
        <!-- Thêm Script -->
        <script src="/website_khoacntt_caothang/public/js/carousel.js"></script>
      </div>
    </div>
    <!-- Wave -->
          ...
          <div class="relative">
            <div class="about-item__image-container overflow-hidden rounded-2xl">
              <div class="image-wrapper">
                <img class="image w-full h-full object-fit" src="/website_khoacntt_caothang/public/img/about.jpg"
      ...
      <div class="wcu__content flex flex-col items-center justify-center">
        ...
        <div class="wcu__features-grid grid grid-cols-3 grid-rows-2 gap-6 mb-6 self-stretch">
          ...
          <div class="wcu__feature-card wcu__feature-card--large wcu-feature-container overflow-hidden relative col-span-2 row-span-2 rounded-3xl image-wrapper">
            <img
              class="wcu__feature-card-image image"
            ...
            <div class="wcu__feature-card-content absolute inset-0 flex flex-col justify-end items-start p-8">
              ...
              <a href="#" class="wcu__feature-card-link text-base font-normal">
                Khám phá ngay
                <svg class="wcu__feature-card-link-icon" alt="Top right arrow Icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="wcu__perks-list flex justify-center items-stretch self-stretch gap-6 mb-6">
          ...
          <div class="wcu__perk-item flex flex-col items-start justify-start flex-1 rounded-2xl p-6">
            <div class="wcu__perk-item-icon-wrapper flex justify-center items-center rounded-full text-4xl mb-4 p-3">
              <svg class="wcu__perk-item-icon" alt="Code Icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="wcu__perk-item flex flex-col items-start justify-start flex-1 rounded-2xl p-6">
            <div class="wcu__perk-item-icon-wrapper flex justify-center items-center rounded-full text-4xl mb-4 p-3">
              <svg class="wcu__perk-item-icon" alt="People Icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="wcu__perk-item flex flex-col items-start justify-start flex-1 rounded-2xl p-6">
            <div class="wcu__perk-item-icon-wrapper flex justify-center items-center rounded-full text-4xl mb-4 p-3">
              <svg class="wcu__perk-item-icon" alt="Medal Icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="wcu__perk-item flex flex-col items-start justify-start flex-1 rounded-2xl p-6">
            <div class="wcu__perk-item-icon-wrapper flex justify-center items-center rounded-full text-4xl mb-4 p-3">
              <svg class="wcu__perk-item-icon" alt="Rocket Icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="wcu__highlights-list flex justify-center items-stretch self-stretch gap-6">
          ...
          <div class="wcu__highlight-item flex-1 overflow-hidden relative rounded-2xl image-wrapper">
            <img
              class="wcu__highlight-item-image image object-fit"
              src="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?..."
              alt="Trường Cao Thắng" />
        ...
        <div id="newsfeed-other" class="flex flex-col gap-4">
          <div class="newsfeed__other-header flex">
            ...
            <a href="#" class="newsfeed__view-all-link flex items-center gap-1 text-base font-medium link-hover--underline">
              Xem thêm
              <svg class="newsfeed__view-all-icon" alt="Top right arrow Icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.83334 5.83325H14.1667V14.1666" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M5.83334 14.1666L14.1667 5.83325" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </a>
    ...
    <div class="footer__main-content container flex gap-16 py-12 px-4">
      ...
      <div class="footer__info">
        <div class="footer__brand-group flex gap-3 mb-4 items-center">
          <div class="footer__logo overflow-hidden rounded-full">
            <img
              class="footer__logo-image w-full h-full object-fit"
              src="/website_khoacntt_caothang/public/img/faculty_logo.jpg"
              alt="Logo Khoa CNTT cua Truong CDKT Cao Thang" />
          </div>
      ...
      <div class="footer__nav-group flex-1">
        ...
        <ul class="footer__contact-list">
          <li class="footer__contact-item mb-3 flex gap-3">
            <span class="footer__contact-icon">
              <svg alt="Address Icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li class="footer__contact-item mb-3 flex gap-3">
            <span class="footer__contact-icon">
              <svg alt="Email Icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <ul class="footer__social-list flex gap-2 items-center">
          ...
          <li class="footer__social-item">
            <a href="#" class="footer__social-link p-3 link-hover--standout">
              <svg alt="Youtube Icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li class="footer__social-item">
            <a href="#" class="footer__social-link p-3 link-hover--standout">
              <svg alt="Instagram Icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
