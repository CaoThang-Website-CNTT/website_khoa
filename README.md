...
- Thêm hoặc chỉnh sửa (nếu tồn tại) file `index.php` theo đoạn code sau:
...
header('Location: ' . $uri . '/website_khoacntt_caothang/');
exit;
?>
Something is wrong with the XAMPP installation :-(
```

- Bật **Xampp Control Panel**.- Chạy và mở **Apache** và bạn sẽ thấy nội dung của file `public/index.html`.
